    ...
    <div className='flex flex-row justify-end px-[20px] py-[20px] gap-[20px] z-10'>
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className={`absolute outline-none top-[110px] right-[82px] p-3 text-[24px] bg-[#FFEFD3] text-[#E22613] rounded-full transition-all duration-500 ease-in-out placeholder:text-[24px] placeholder:text-[#E22613] ${isSearchOpen ? 'w-[513px] opacity-100' : 'w-0 opacity-0'
            }`}
