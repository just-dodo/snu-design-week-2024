...
export default function XBar({
  ...
  return (
    <div className='w-full'>
        ...
        <XWrapper>
          <div className='flex flex-row w-full h-full justify-between px-4 md:px-0'>
            <div className="flex md:flex-1 flex-row w-full h-full justify-start items-center">
              <p className='text-lg leading-5 bg-red align-bottom font-bold'>{leftTitle}</p>
            </div>
            <div className="flex md:flex-1 flex-row h-full justify-end md:justify-between items-center">
              <p className='hidden md:inline text-lg leading-5 align-bottom font-bold'>{rightTitle}</p>
      ...
      {children ? (
        <div className={`align-center-top flex-1 w-full bg-white text-primary text-xl ${isChildrenShown ? "border-y-primary border-b" : null}`}>
          <XWrapper
          >
            {children}
          </XWrapper>
