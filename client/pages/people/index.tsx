...
const People: NextPage = () => {
  ...
  return (
    <div className='md:pt-[92px] w-full flex flex-col items-center'>
      ...
      <div className="md:pt-[88px] pt-[35px] mb-[100px] md:w-[900px] flex flex-col items-center gap-[20px] min-h-screen">
        ...
        <div className="flex flex-row md:gap-[100px] gap-[63.5px] items-center mt-[5px] mb-[12px]">
          <div
            ...
            className={`flex flex-col items-center w-auto cursor-pointer ${selectedCategory === "visualDesign" ? null : "opacity-50"
              }`}
          >
          ...
          <div
            ...
            className={`flex flex-col items-center w-auto cursor-pointer ${selectedCategory === "visualDesign" ? "opacity-50" : null
              }`}
          >
