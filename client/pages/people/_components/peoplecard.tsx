...
export default function PeopleCard({ people }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-between border-2 border-primary rounded-[16px] md:w-[154px] w-[165px] md:h-[203px] h-[161px] relative">
      <div className="absolute top-[10px] left-[10px] md:w-[26px] w-[18px] md:h-[26px] h-[18px] border-2 border-primary rounded-full"></div>
